...
estimate_DPE <- function(menage_forme, save_intermed_file = FALSE){
...
# Attribution DPE ---------------------------------------------------------
  ...
  if(save_intermed_file){save(menage_DPE , file = MatisseFiles$menage_dpe_rd)}
  return(menage_forme)
